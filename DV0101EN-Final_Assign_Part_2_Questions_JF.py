...
{'label': 'Recession Period Statistics', 'value': 'Recession Period Statistics'}]
  ...
  dcc.Dropdown(id='dropdown-stastics', 
                   options=[
                           {'label': 'Yearly Statistics', 'value': 'Yearly Statistics'},
                           {'label': 'Recession Period Statistics', 'value': 'Recession Period Statistics'}
                           ],
                  placeholder='Select a report type',
                  style={'wdith': 80%, 'padding':3px, ‘font-size’: 20px, 'text align': 'center'})

  dcc.Dropdown(id='Select-year', 
                   options=[{'label': i, 'value': i} for i in year_list],
                  placeholder='Select a year',
                  style={'wdith': 80%, 'padding': 3, ‘font-size’: 20, 'text align': 'center'})
...
# Create the layout of the app
    ...
    app.layout = html.Div([html.H1("Automobile Sales Statistics Dashboard",style={'textalign:'left','color':'#503d36','font_size':24}),
...
@app.callback(Output(component_id='output-container', component_property='children'), [Input(component_id='dropwdown_statistics', component_property='value'), Input(component_id='select-year', component_property='value')])
